...
**408 variables** across 37 sections.
...
- [palettes light](#palettes-light) · 23
...
| Variable | Default | Description |
| --- | --- | --- |
| `--link-color` | `var(--color-primary)` | Link color. |
| `--link-hover-color` | `var(--color-primary-hover)` | Link hover color. |
...
| `--input-background` | `var(--color-surface)` | Input background. |
