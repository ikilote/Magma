export const menu = [
    ...
    },
    {
        ...
        items: [
            ...
            { routerLink: '/component/ellipsis-button', label: 'Ellipsis button', status: 'new' },
            ...
            { routerLink: '/component/walkthrough', label: 'Walkthrough', status: 'update' },
        ],
    },
    {
        ...
        items: [
            ...
            { routerLink: '/directive/ng-model-change-debounced', label: 'ngModelChange debounced', status: 'update' },
            { routerLink: '/directive/sortable', label: 'Sortable' },
            { routerLink: '/directive/stop-propagation', label: 'Stop Propagation' },
            { routerLink: '/directive/tooltip', label: 'Tooltip', status: 'update' },
    ...
    },
    {
        groupName: 'Services',
        items: [
            { routerLink: '/service/cache', label: 'Cache', status: 'update' },
    ...
    },
    {
        ...
        items: [
            ...
            { routerLink: '/utils/date', label: 'Date', status: 'update' },
            { routerLink: '/utils/dom', label: 'DOM', status: 'update' },
            { routerLink: '/utils/email', label: 'Email' },
            { routerLink: '/utils/enum', label: 'Enum' },
            { routerLink: '/utils/file', label: 'File', status: 'update' },
            { routerLink: '/utils/json', label: 'Json' },
            { routerLink: '/utils/number', label: 'Number' },
            { routerLink: '/utils/object', label: 'Object' },
            { routerLink: '/utils/text', label: 'Text', status: 'update' },
