...
export class TestComponent {
  ...
  <thead mg>
    <tr mg>
      <th mg [sortRule]="{ type: 'string', attr: 'col1', init: 'asc' }">Col 1</th>
      <th mg sortRule="col2">Col 2</th>
      <th mg [sortRule]="{ type: 'string', attr: 'col3' }">Col 3</th>
      <th mg [sortRule]="{ type: 'string', attr: 'col4' }">Col 4</th>
      <th mg [sortRule]="{ type: 'number', attr: 'col5.value' }">Col Num</th>
      <th mg [sortRule]="{ type: 'date', attr: 'col5.date' }">Col Date</th>
      <th mg sortRule="col6.value:number,col5.value:number">Col Num+</th>
    </tr>
  </thead>
  <tbody mg>
...
<table
  ...
  hover
  [sortable]="items"
  [sortableFilterInput]="inputFilter"
  [sortableFilter]="sortableFilter"
  class="s-12"
>
  <thead mg>
    <tr mg>
      <th mg [sortRule]="{ type: 'string', attr: 'col1' }">Col 1</th>
      <th mg [sortRule]="{ type: 'string', attr: 'col2' }">Col 2</th>
      <th mg [sortRule]="{ type: 'string', attr: 'col3' }">Col 3</th>
      <th mg [sortRule]="{ type: 'string', attr: 'col4' }">Col 4</th>
      <th mg [sortRule]="{ type: 'number', attr: 'col5.value' }">Col Num</th>
      <th mg [sortRule]="{ type: 'date', attr: 'col5.date' }">Col Date</th>
